      ...
      <div className=" p-4  sm:p-5  md:p-6  lg:p-6   bg-white">
        ...
        <div className="mt-3 text-lg">
          ...
          <p className="my-4 mt-7">
            Contentia, müşteri firmaların ve markaların ürün, hizmet ya da mekan
            tanıtımları için içerik üreticileriyle çalışarak UGC, influencer
            pazarlaması ve çeşitli sosyal medya tanıtımları satın alabileceği
            bir platform.
          </p>
          <p>
            Yalnızca 5 dakikanı ayırarak, İçerik Üreticisi formunu doldurarak
            içerik üreticileri arasında yer alabilir ve ürettiğin içeriklerden
            gelir elde edebilirsin.
          </p>
        </div>
