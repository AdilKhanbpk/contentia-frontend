      ...
      <div className='px-4 sm:px-6 md:px-8 lg:px-28'>
          ...
          <div className='bg-white p-5  sm:p-5  md:p-6  lg:p-6 '>
            <div className='flex flex-col lg:flex-row justify-start items-start lg:items-start'>
              <div className='w-full lg:w-1/4 flex flex-col mb-6 lg:mb-0'>
                <h1 className='text-lg font-semibold whitespace-nowrap'>Profil Bilgileri</h1>
                <img className='w-36 h-36 mt-4' src='https://avatar.iran.liara.run/public/24' alt='ProfileImage' />
              </div>
                  ...
                  <div className='flex flex-col lg:flex-row gap-6'>
                    ...
                    <div className='flex flex-col gap-4 w-full lg:w-1/2'>
                      ...
                      <div className="mb-4 w-full sm:w-1/2 md:w-1/2 lg:w-full  mt-2 grid grid-cols-3">
                        <label className="col-span-3 block text-base font-medium text-gray-700 mb-2">Cinsiyet: <span className='font-medium'>(Opsiyonel)</span></label>
            ...
            <div className='flex justify-end'>
              <button className='ButtonBlue text-white text-base font-semibold rounded-xl p-1 px-14'>İleri</button>
            </div>
          </div>
        </div>
        ...
        <div className=' bg-white  p-5  sm:p-5  md:p-6  lg:p-6  py-3 mt-14'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <button className='ButtonBlue text-white text-base font-semibold rounded-2xl p-1 mt-5 px-8'>Doğrula</button>
            <p className='mt-3'>Tekrar Gönder (02:00)</p>
            <p className='text-base font-semibold BlueText mt-3'>Numara Değiştir</p>
          </div>
        </div>
      </div>
    </>
