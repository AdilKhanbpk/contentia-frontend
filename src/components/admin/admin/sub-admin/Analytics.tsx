        ...
        <>
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <div className="col-span-1">
                        <AnalyticEcommerce title="Total Users" count="78,250" percentage={70.5} color="text-green-500" extra="8,900" />
                    </div>
                    <div className="col-span-1">
                        <AnalyticEcommerce title="Total Orders" count="18,800" percentage={27.4} isLoss color="text-yellow-500" extra="1,943" />
                    </div>
                    <div className="col-span-1">
                        <AnalyticEcommerce title="Total Sales" count="$35,078" percentage={27.4} isLoss color="text-red-500" extra="$20,395" />
                    </div>
                </div>
                <div className='my-4'>
                    <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-center mb-2">
                                <h5 className="text-lg font-semibold">Unique Visitor</h5>
                        ...
                        <div className="flex-1 md:w-1/3">
                            ...
                            <div className="bg-white shadow-lg rounded-lg p-4 mt-2">
                                <div className="pb-4">
                                    <h6 className="text-gray-500">This Week Statistics</h6>
