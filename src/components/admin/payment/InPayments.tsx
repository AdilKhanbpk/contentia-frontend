...
const initialOrders: Order[] = [
  ...
  { id: 3, customerName: "Ahmed", customerSurname: "Barut", paymentID: 9084734, paymentDate: "10/08/2024", amountPaid: "45,000 TL", paymentStatus: "Success", cancelRefund: "Not Refunded" },
];
...
const InPayments: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row: any) => row.customerSurname,
      sortable: true,
      width: "200px",
    },
    {
    ...
    },
    {
      ...
      cell: (row: any) => (
        <div className="flex space-x-3">
          <button className="text-blue-500 hover:text-blue-700">Invoice</button>
  ...
  const exportToCSV = () => {
    const csvRows = [
      ...
      ...initialOrders.map(order => [order.id, order.customerName, order.customerSurname, order.paymentID, order.paymentDate, order.amountPaid, order.paymentStatus, order.cancelRefund]),
    ];
