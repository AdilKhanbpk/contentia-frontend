                    ...
                    <table className="text-xs lg:text-sm w-auto lg:min-w-full bg-white">
                        <thead>
                            <tr>
                                ...
                                <th className="py-0.5 px-0.5 sm:py-0.5 sm:px-0.5 md:py-2 md:px-4 lg:py-2 lg:px-4 text-start border">Order ID</th>
                                <th className="py-0.5 px-0.5 sm:py-0.5 sm:px-0.5 md:py-2 md:px-4 lg:py-2 lg:px-4 text-start border">Package Contents Delivered</th>
                                <th className="py-0.5 px-0.5 sm:py-0.5 sm:px-0.5 md:py-2 md:px-4 lg:py-2 lg:px-4 text-start border">Order Date</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td className="py-0.5 px-0.5 sm:py-0.5 sm:px-0.5 md:py-2 md:px-4 lg:py-2 lg:px-4 border">1</td>
                            ...
                            <tr>
                                ...
                                <td className="py-0.5 px-0.5 sm:py-0.5 sm:px-0.5 md:py-2 md:px-4 lg:py-2 lg:px-4 border">4</td>
                            ...
                            <tr>
                                ...
                                <td className="py-0.5 px-0.5 sm:py-0.5 sm:px-0.5 md:py-2 md:px-4 lg:py-2 lg:px-4 border">6</td>
