                ...
                <div className='flex flex-col'>
                    <div className="p-6 my-8">
                        ...
                        <div className="bg-white p-6  pb-4 mb-4">
                            <div className="flex flex-row justify-between items-end space-x-28">
                                {/* First Section */}
                                <div className="bg-white rounded-md">
                                    <h3 className="text-lg font-semibold mb-4 BlueText">Launch</h3>
                                ...
                                <div className="">
                                    <button onClick={openModal} className="border BlueBorder BlueText font-semibold px-4 py-1 rounded-lg">
                                        Detaylar
                                    </button>
                                </div>
                            </div>
                        ...
                        <CustomModal isOpen={isModalOpen} closeModal={closeModal} title="">
                            ...
                            <div className="bg-white my-8 p-6">
                                ...
                                <div className='flex flex-row space-x-28'>
                                    ...
                                    <div className="bg-white rounded-md mb-8">
                                        <h3 className="text-lg font-semibold mb-4 BlueText">Paket Bilgileri:</h3>
                                        <div className="grid grid-cols-2 gap-4">
                                            {/* Ödeme No */}
                                            <div className="text-gray-700">Ödeme No:</div>
                                            <div className="text-right BlueText font-semibold">201240184112</div>

                                            {/* Ödeme Tarihi */}
                                            <div className="text-gray-700">Ödeme Tarihi:</div>
                                            <div className="text-right BlueText font-semibold">19/09/2024</div>

                                            {/* İçerik Sayısı */}
                                            <div className="text-gray-700">İçerik Sayısı:</div>
                                            <div className="text-right BlueText font-semibold">9 / 12</div>

                                            {/* Paket Durumu */}
                                            <div className="text-gray-700">Paket Durumu:</div>
                                            <div className="text-right BlueText font-semibold">Aktif / Tamamlandı / İptal</div>
                                    ...
                                    <div className="bg-white rounded-md mb-8">
                                        <h3 className="text-lg font-semibold mb-4 BlueText">Sipariş Özeti:</h3>
                                ...
                                <div className="flex">
                                    <div className="bg-white rounded-md w-1/3">
                                        <h2 className="BlueText text-lg font-semibold mb-4">İçerik Detayı:</h2>
