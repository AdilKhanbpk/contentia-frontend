  ...
  return (
    <div className="my-3 mt-28">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 lg:grid-cols-2 gap-8">
        {currentBlogs.map((blog: BlogFormData) => (
          <div key={blog._id} className="w-full rounded-md shadow-md p-4 flex flex-col items-center bg-white">
            <Image
            ...
            <div className="px-2 mt-2 text-center">
              <p className="text-gray-600">
                {formatDate(blog.createdAt)} - {estimateReadTime(blog.content)}
              </p>
