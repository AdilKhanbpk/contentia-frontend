            ...
            <div className="p-6 bg-white rounded-lg shadow-md w-full ">
                ...
                <div className='flex flex-col lg:flex-row justify-between items-center lg:space-x-4'>
                    ...
                    <div className="mb-4 w-full lg:w-1/3 mt-2 grid grid-cols-3">
                        <label className="col-span-3 block text-sm font-semibold text-gray-700 mb-2">Cinsiyet: <span className='font-medium'>(Opsiyonel)</span></label>
                ...
                <div className='w-full flex justify-end items-end'>
                    <button className="mt-6 ButtonBlue text-white py-2 px-4 rounded-md">
                        Tamamla
                    </button>
                </div>
            </div>
