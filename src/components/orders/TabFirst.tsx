...
const en = {
    ...
    ratio_9_16: "9:16",
    ratio_16_9: "16:9",
    tooltip: "By combining visual content and data, the right social media plan can deliver superior results, better engagement, and measurable impact."
};
...
// Change this to either 'en' or 'tr' to switch languages
...
export default function TabFirst() {
    ...
    const getPrice = (quantity: number, discount: number): string => {
        return (quantity * 3.000 - discount).toFixed(2);
    };
    ...
    const [selectedCard, setSelectedCard] = useState<number | null>(null); // Allow number or null for the selected card
            ...
            <div className=" px-4 sm:px-6 md:px-12 lg:px-24 ">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <div className='sectionBG py-2 flex flex-row px-2 items-end rounded-md'>
                                ...
                                <div className="flex space-x-2">
                                    <button
                                        className={`text-sm px-3 py-1 rounded ${activePlatform === 'tiktok' ? 'ButtonBlue text-white' : 'bg-white text-black'}`}
                                        onClick={() => handlePlatformChange('tiktok')}
                                    >
                                        {currentLanguage.tiktok}
                                    </button>
                                    <button
                                        className={`text-sm px-3 py-1 rounded ${activePlatform === 'meta' ? 'ButtonBlue text-white' : 'bg-white text-black'}`}
                                        onClick={() => handlePlatformChange('meta')}
                                    >
                                        {currentLanguage.meta}
                                    </button>
                                    <button
                                        className={`text-sm px-3 py-1 rounded ${activePlatform === 'other' ? 'ButtonBlue text-white' : 'bg-white text-black'}`}
                ...
                <div className=" my-2 px-4 py-2 sm:my-3 sm:px-8 sm:py-4 md:my-4 md:px-12 md:py-5 lg:my-4 lg:px-16 lg:py-6 bg-white">
                    ...
                    <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div
                            ...
                            className={`p-2 sm:p-3 md:p-4 lg:p-4 rounded-lg shadow-xl cursor-pointer ${selectedCard === 3 ? 'border-2 BlueBorder bg-white' : 'bg-white' // Apply blue background when selected
                                }`}
                        >
                        ...
                        <div
                            ...
                            className={`p-2 sm:p-3 md:p-4 lg:p-4 rounded-lg shadow-xl cursor-pointer ${selectedCard === 6 ? 'border-2 BlueBorder sectionBG' : 'sectionBG' // Apply blue background when selected
                                }`}
                        >
                        ...
                        <div
                            ...
                            className={`p-2 sm:p-3 md:p-4 lg:p-4 rounded-lg shadow-xl cursor-pointer ${selectedCard === 12 ? 'border-2 BlueBorder bg-white' : 'bg-white' // Apply blue background when selected
                                }`}
                        >
                        ...
                        <div
                            ...
                            className={`bg-white rounded-lg p-2 sm:p-3 md:p-4 lg:p-4 shadow-xl cursor-pointer ${selectedCard === 4 ? 'border-2 BlueBorder bg-white' : 'bg-white' // Apply blue background when selected
                                }`}
                        >
                            ...
                            <p className="mt-6 text-sm BlueText font-semibold">{getPrice(selectedQuantity, 0)} TL <span className="text-xs text-black font-thin"> / Video</span></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white p-2 sm:p-3 md:p-4 lg:p-4 rounded-lg shadow-md flex flex-col lg:flex-row justify-between items-center">
                                ...
                                <div className="w-2/3 ml-2 sm:ml-3 md:ml-4 lg:ml-4 flex flex-col">
                                    ...
                                    <button className="mt-2 px-2 py-1 border-2 BlueBorder BlueText rounded-md font-semibold w-14">Ekle</button>
                                </div>
                            </div>
                                ...
                                <div className="w-2/3 ml-2 sm:ml-3 md:ml-4 lg:ml-4 flex flex-col">
                                    <div className='flex flex-row justify-between items-center'>
                                        ...
                                        <div className="relative w-1/4 flex justify-end items-end">
                                            ...
                                            {showTooltipTwo && (
                                                <div className="absolute left-0 top-full mb-1 w-48 bg-gray-700 text-white text-sm rounded p-2">
                                                    İçerikleriniz 10k ve üzeri takipçili, profesyonel kamera, mikrofon ışıklandırma vb. ekipmanlara sahip içerik üreticileri tarafından üretilir
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="w-2/3 ml-2 sm:ml-3 md:ml-4 lg:ml-4 flex flex-col">
                                    <div className='flex flex-row justify-between items-center'>
                                        ...
                                        <div className="relative w-1/4 flex justify-end items-end">
                                            ...
                                            {showTooltipThree && (
                                                <div className="absolute left-0 top-full mb-1 w-48 bg-gray-700 text-white text-sm rounded p-2">
                                                    İçerik üreticilere gönderim sağladığınız ürünler hediye niteliğindedir. Ürünlerinizin geri gönderimi sağlanmaz ve içerik üreticilere hedilye edilmiş sayılır
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    <p className="text-gray-600">İçeriklerinizde tanıtımını yapmak istediğiniz ürünü, içerik üreticilerin adreslerine
                                        kargolamanız gerekir. Kargo kodu ile gönderimini ek ücret ödemeden sağlayabilirsiniz</p>
                ...
                <div className="bg-white my-2 py-2 px-4 sm:my-3 sm:py-3 sm:px-5 md:my-4 md:py-4 md:px-6 lg:my-4 lg:py-4 lg:px-6 flex justify-end items-center border-gray-300">
                    ...
                    <div className='mr-4'>
                        ...
                        <p className="text-sm text-indigo-500">Toplam: 3.000 TL</p>
                    </div>

                    {/* Button */}
                    <button className="ButtonBlue text-white font-semibold py-2 px-4 rounded-lg">
                        İleri
                    </button>
                </div>
