    ...
    >
      ...
      <div className="w-full mt-4 lg:mt-0 flex flex-col">
        ...
        <div className="flex flex-col mb-2">
          ...
          <input
            {...register("brandName", { required: "Marka Adı zorunludur" })}
            type="text"
            id="brandName"
        ...
        {/* Marka Kategorisi */}
        <div className="flex flex-col mb-2">
          <label htmlFor="brandCategory" className="mb-1">
            Marka Kategorisi:
          </label>
          <input
        ...
        <div className="flex flex-col mb-2">
          <label htmlFor="brandWebsite" className="mb-1 whitespace-nowrap">
            Marka Websitesi: (Opsiyonel)
          </label>
          <input
        ...
        <div className="flex flex-col mb-2">
          ...
          <input
            {...register("brandCountry", { required: "Ülke zorunludur" })}
            type="text"
            id="country"
            className="p-2 border rounded focus:outline-none  w-72 md:w-96"
            placeholder="Ülke"
          />
          {errors.brandCountry && (
            <p className="text-red-500 text-sm">{errors.brandCountry.message}</p>
          )}
        </div>
      </div>
