...
const TabThird: React.FC<{ setActiveTab: (id: number) => void }> = ({
  ...
  const onSubmit = async (data: any) => {
    ...
    toast.success("Sipariş özeti başarıyla kaydedildi!");
    setActiveTab(3);
  };
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {errors.brand && (
                <span className="text-red-500">Marka Seçimi zorunludur</span>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errors.productName && (
                <span className="text-red-500">Ürün adı zorunludur</span>
              )}
            </div>
          ...
          <div className="mt-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              İçerik üreticilerine iletmek istediğiniz marka, logo, ürün veya
              hizmet görseli, lütfen dosyanızı yükleyin.
            </p>
            <div
              ...
              <div className="flex flex-col lg:flex-row justify-center lg:space-x-8">
                ...
                <div className="w-full lg:w-5/6">
                  <p className="text-sm text-gray-500 lg:-ml-8">
                    Dosyalarınızı sürükleyin ya da Yükle butonuna basarak
                    cihazınızdan seçin.
                  </p>
