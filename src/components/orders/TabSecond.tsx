          ...
          <div className="bg-white border rounded-lg p-6 shadow-md w-full">
            ...
            <div className="mt-4 flex flex-col ">
              ...
              <div className='flex flex-col lg:flex-row  lg:space-x-3'>
                ...
                />
                <div><button className="ButtonBlue text-white px-4 py-2 rounded-md font-semibold">
                  Uygula
                </button></div>
              </div>
            </div>
                ...
                {isTooltipVisible && (
                  <div className="absolute top-10 left-1/2 transform -translate-x-1/2 bg-red-500 text-white text-sm px-2 py-1 rounded">
                    <div className='flex flex-col'>
                      ...
                      <span className='whitespace-nowrap'> 30 Days - 35 Days</span>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="w-full bg-white p-8 shadow-lg rounded-md">
              ...
              <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                  ...
                  />
                  {errors.cardNumber && <span className="text-red-500">Kart numarası gerekli</span>}
                </div>

                {/* Expiry and CVV */}
                <div className="flex space-x-4">
                  <div className="w-2/2 lg:w-1/2">
                    <label className="block text-sm font-semibold mb-1">Son Kullanma Tarihi</label>
                    <input
                      type="text"
                      placeholder="AA/YY"
                      className="w-full px-3 py-2 border rounded-md focus:outline-none"
                    ...
                    />
                    {errors.expiryDate && <span className="text-red-500">Son kullanma tarihi gerekli</span>}
                  </div>
                  <div className="w-2/2 lg:w-1/2">
                    ...
                    />
                    {errors.cvv && <span className="text-red-500">CVV gerekli</span>}
                  </div>
                </div>

                {/* Name on Card */}
                <div>
                  <label className="block text-sm font-semibold mb-1">İsim Soyisim</label>
                  <input
                    type="text"
                  ...
                  />
                  {errors.nameOnCard && <span className="text-red-500">İsim soyisim gerekli</span>}
                </div>

                {/* Country and City */}
                <div className="">
                  <label className="block text-sm font-semibold mb-1">Ülke</label>
                  <select
                    className="w-full px-3 py-2 border rounded-md focus:outline-none"
                  ...
                  {errors.country && <span className="text-red-500">Ülke gerekli</span>}
                </div>

                <div className="">
                  <label className="block text-sm font-semibold mb-1">Contentia’yı Nereden Duydun</label>
                  <input
                    type="text"
                    placeholder="Opsiyonel"
                    className="w-full px-3 py-2 border rounded-md focus:outline-none"
                    {...register("whereDidYouHear", { required: false })}
                  />
                </div>

                {/* Invoice Information */}
                <h2 className="text-xl font-semibold mt-8 mb-4">Fatura Bilgileri</h2>

                {/* Company Name */}
                <div>
                  <label className="block text-sm font-semibold mb-1">Ad Soyad / Şirket Ünvanı</label>
                  <input
                    type="text"
                  ...
                  />
                  {errors.companyName && <span className="text-red-500">Ad Soyad / Şirket Ünvanı gerekli</span>}
                </div>

                {/* Tax/VAT ID */}
                <div>
                  <label className="block text-sm font-semibold mb-1">TCKN / VKN</label>
                  <input
                    type="text"
                  ...
                  />
                  {errors.taxId && <span className="text-red-500">TCKN / VKN gerekli</span>}
                </div>

                {/* Tax Office */}
                <div>
                  <label className="block text-sm font-semibold mb-1">Vergi Dairesi (Opsiyonel)</label>
                  <input
                    type="text"
                    placeholder="Opsiyonel"
                    className="w-full px-3 py-2 border rounded-md focus:outline-none"
                    {...register("taxOffice", { required: false })}
                  />
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.address && <span className="text-red-500">Adres gerekli</span>}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.email && <span className="text-red-500">E-posta gerekli</span>}
                </div>

                {/* Phone Number */}
                <div>
                  <label className="block text-sm font-semibold mb-1">Telefon Numarası</label>
                  <input
                    type="text"
                    className="w-full px-3 py-2 border rounded-md focus:outline-none"
                    {...register("phoneNumber", { required: true })}
                  />
                  {errors.phoneNumber && <span className="text-red-500">Telefon numarası gerekli</span>}
                </div>
                ...
                {/* Submit Button */}
                <button type="submit" className="w-full ButtonBlue text-white px-4 py-2 rounded-md font-semibold">
                  <div className='flex flex-row space-x-8'>
                    <div className='w-1/4 flex justify-end items-center'>
                      <img src="/lockIcon.png" alt="brand logo" height={20} width={20} className="" />
                    </div>
                ...
                <div className="flex items-center">
                  ...
                  {errors.agreement && <span className="text-red-500">Bu alan zorunludur</span>}
                </div>
              </form>
            </div>
          </div>
